 ...
 */
export default function createEnvironmentApi({ http }: {
    http: AxiosInstance;
}): {
    /**
     ...
     * ```
     */
    getUiExtensions(): Promise<import("./common-types").Collection<import("./entities/ui-extension").UIExtension, import("./entities/ui-extension").UIExtensionProps>>;
    /**
     ...
     * ```
     */
    createUiExtension(data: CreateUIExtensionProps): Promise<import("./entities/ui-extension").UIExtension>;
    /**
     ...
     * ```
     */
    createUiExtensionWithId(id: string, data: CreateUIExtensionProps): Promise<import("./entities/ui-extension").UIExtension>;
    /**
    ...
    createTag(id: string, name: string): Promise<import("./entities/tag").Tag>;
